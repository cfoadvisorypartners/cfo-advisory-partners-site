...
function NextStepsSection() {
  ...
  return (
    <section className="bg-[#f7f3ee] px-6 py-24 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            ...
            stronger people, or clearer strategy becomes the priority. We help
            you focus on what matters most — and build from there.
          </p>
        </div>

        <div className="mx-auto mt-16 max-w-5xl overflow-hidden rounded-[2rem] bg-white shadow-2xl shadow-slate-900/10 ring-1 ring-slate-200">
          <div className="grid lg:grid-cols-[1.05fr_0.95fr]">
            <div className="relative min-h-[360px] overflow-hidden bg-slate-900">
              <img
                src={activeStep.image}
                alt={activeStep.title}
                className="h-full min-h-[360px] w-full object-cover transition-all duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950/45 via-slate-950/10 to-transparent" />
            </div>

            <div className="flex min-h-[360px] flex-col justify-center p-8 text-center lg:p-12 lg:text-left">
