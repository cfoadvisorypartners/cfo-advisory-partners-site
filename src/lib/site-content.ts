...
export const verticals = [
  ...
  "Other Established Growing Businesses",
];

export const testimonials = [
  {
    quote: "We finally had reporting we could actually use to make decisions.",
    source: "Owner, growing service business",
  },
  {
    quote:
      "The monthly cadence brought consistency, accountability, and much better financial visibility.",
    source: "President, multi-entity company",
  },
  {
    quote:
      "What stood out was not just the analysis, but the structure put in place behind it.",
    source: "CEO, established operating business",
  },
];
