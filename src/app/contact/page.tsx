      ...
      <main className="mx-auto max-w-5xl px-6 py-20 lg:px-10">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            ...
            <a
              href="tel:9723107252"
              className="mt-2 inline-block text-lg font-semibold text-slate-900 transition hover:text-blue-600"
            >
              (972) 310-7252
            </a>
          </div>
          ...
          <div className="rounded-[2rem] bg-white p-8 shadow-sm">
            ...
            <Link
              href="/lead"
              className="mt-6 inline-block rounded-2xl bg-slate-900 px-5 py-3 text-white !text-white"
            >
